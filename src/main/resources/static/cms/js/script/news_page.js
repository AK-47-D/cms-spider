$(function () {
    ...
    function doNewsAjax(pageNum, pageSize) {
        ...
        //                                             row.title+
        //                                         "</a>" +
        //                                         "<a code=a_"+index+" target=\"_blank\" href=\"/premium/articles/3039367\" class=\"news-item__main__summary\">" +
                ...
                columns: [{
                    ...
                    formatter: function (value, row, index) {
                        return "<div data-news>" +
                            ...
                            row.title+
                            "</a>" +
                            "<a code=a_"+$('.page-number.active').find('a').html()+"_"+index+" target=\"_blank\" href=\"/premium/articles/3039367\" class=\"news-item__main__summary\">" +
                            row.html.substring(0,(row.html.indexOf('</p>')+4))+'...'+
                            "</a>" +
                            "<div class=\"news-item__main__meta\">" +
                            "<div class=\"news-item__main__meta__left\">" +
