    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.clickToSelect || this.options.singleSelect) {
            ...
            if (this.options.copyBtn) {
                var copybtn = "<button class='btn btn-default' code='copyBtn'><span class='glyphicon glyphicon-copy icon-pencil'></span></button>";
                $btnGroup.append(copybtn);
                $btnGroup.find('#copyBtn').click(function () { that.copyColumnsToClipboard(); });
            }

            if (this.options.copyWHiddenBtn) {
                var copyhiddenbtn = "<button class='btn btn-default' code='copyWHiddenBtn'><span class='badge'><span class='glyphicon glyphicon-copy icon-pencil'></span></span></button>";
