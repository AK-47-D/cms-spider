    ...
    <div class="container-fluid">
        ...
        <div>
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="https://universsky.github.io/" target="_blank">书</a>
                </li>

                <li class="<#if requestURI?if_exists =="/tech_article_view">active</#if>">
                    <a href="tech_article_view">文章</a>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="https://www.weibo.com/oranread" target="_blank">微博</a></li>
                        <li><a href="https://www.jianshu.com/u/c55c7a9c8de6" target="_blank">简书</a></li>
                    </ul>
                </li>
